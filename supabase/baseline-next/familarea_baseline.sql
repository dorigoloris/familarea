...
begin
  ...
  if coalesce(new.raw_app_meta_data->>'provider','')='google' then v_type:='personal'; else v_type:=coalesce(new.raw_user_meta_data->>'account_type','personal'); end if;
